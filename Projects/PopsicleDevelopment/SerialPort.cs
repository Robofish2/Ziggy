...
{
    /// <summary>
    /// Class used to send and receive messages on an RS232 Com Port.
    /// </summary>
    public class SerialPort
    {
        ...
        /// <summary>
        /// Custom Event Handler to send Com Port status message update to subscribers.
        /// </summary>
        public event EventHandler<SerialPortCustomEventArgs> SerialPortStatusMessageUpdate;
        /// <summary>
        /// Custom Event Handler to send TCP/IP message to subscribers.
        /// </summary>
        public event EventHandler<SerialPortCustomEventArgs> SerialPortTCP_MessageUpdate;
        /// <summary>
        /// Custom Event Handler to inform subscribers when the Connected propery changes.
        /// </summary>
        public event EventHandler<SerialPortCustomEventArgs> SerialPortConnected;
